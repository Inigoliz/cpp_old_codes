/* Archivo para aprender a manejar la clase "matrix.h"*/
...
// IMP: QUE LA INCLUSION DE LOS #include APAREZCA EN ESE ORDEN
#include <string.h>
#include <iostream>
#include <fstream>
using namespace std;
...
int main(){
  ...
  cout<<"Elementos de matriz A"<<endl;
  cout<<A<<endl;

  //Definicion de matriz 3x1 con elementos de tipo double
  matrix<double> x(3,1); // una columna
  ...
  matrix<double> b(3,1); // hay que crear b antes, que debe ser igual que a
  b=A*x;
  cout<<" b = A * x "<<endl;
  cout<<b<<endl;
